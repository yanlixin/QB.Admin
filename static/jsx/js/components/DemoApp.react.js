 ...
 */
    ...
    var TodoItem = React.createClass({
        ...
        handleToggle: function(evt) {
            AppActions.toggleItem(this.props.id);
        },
        ...
        handleBlur: function() {
            ...
            if (this.state.isEditing && text) {
                AppActions.editItem(this.props.id, text);
            }
    ...
    var TodoMain = React.createClass({
        ...
        toggleAll: function(evt) {
            AppActions.toggleAllItems(evt.target.checked);
        },
        render: function() {
            var filteredList;
            switch(this.getPath()){
    ...
    var DemoApp = React.createClass({
        ...
        mixins: [Reflux.connect(AppActions,"list")],
